...
const PLUTUS_V1_COST_MODEL = [
  ...
  22151, 32, 91189, 769, 4, 2, 85848, 228465, 122, 0, 1, 1, 1000, 42921, 4, 2,
  24548, 29498, 38, 1, 898148, 27279, 1, 51775, 558, 1, 39184, 1000, 60594, 1,
  141895, 32, 83150, 32, 15299, 32, 76049, 1, 13169, 4, 22100, 10, 28999, 74, 1,
  28999, 74, 1, 43285, 552, 1, 44749, 541, 1, 33852, 32, 68246, 32, 72362, 32,
  7243, 32, 7391, 32, 11546, 32, 85848, 228465, 122, 0, 1, 1, 90434, 519, 0, 1,
  74433, 32, 85848, 228465, 122, 0, 1, 1, 85848, 228465, 122, 0, 1, 1, 270652,
  22588, 4, 1457325, 64566, 4, 20467, 1, 4, 0, 141992, 32, 100788, 420, 1, 1,
...
const PLUTUS_V2_COST_MODEL = [
  ...
  28999, 74, 1, 43285, 552, 1, 44749, 541, 1, 33852, 32, 68246, 32, 72362, 32,
  7243, 32, 7391, 32, 11546, 32, 85848, 228465, 122, 0, 1, 1, 90434, 519, 0, 1,
  74433, 32, 85848, 228465, 122, 0, 1, 1, 85848, 228465, 122, 0, 1, 1, 955506,
  213312, 0, 2, 270652, 22588, 4, 1457325, 64566, 4, 20467, 1, 4, 0, 141992, 32,
...
export const TransformTxTestCases: TransformTransactionTestCase[] = [
  {
    testName:
      'Tx with Plutus scripts should throw when costModels not provided',
  ...
  // https://preview.cardanoscan.io/transaction/72c50cd781dda61f8aa2dce3e9b2ee5691b0e734ae6385d67ea2b16c4855ad77
  {
    ...
    cbor: '',
    costModels: new Map([['PlutusV2' as const, PLUTUS_V2_COST_MODEL]]),
    tx: {
      body: {
        inputs: {
          items: [
  ...
  {
    testName:
      'Tx with PlutusV1 + PlutusV2 inline scripts should recompute scriptDataHash',
      ...
      witnessSet: new Map<unknown, unknown>([
        ...
        [
          ...
          new Map([
            [
              [1, 0],
              [new Tagged(121, []), [toUint(800), toUint(112100)]],
            ],
            [
              [1, 1],
              [new Tagged(121, []), [toUint(800), toUint(112100)]],
  ...
  {
    testName:
      'Tx with reference script (no inline scripts) should recompute scriptDataHash with usedCostModelLanguages',
