...
import type {CddlSet, TransactionInput} from '../../src/types'
...
const ValidInputsTestCases: ValidParseTestCase<CddlSet<TransactionInput>>[] = [
  {
    testName: 'One input',
...
const InvalidInputsTestCases: InvalidParseTestCase[] = [
  ...
  },
  {
    ...
    cbor: '',
    errMsg: ParseErrorReason.INVALID_TX_INPUTS,
  },
  {
