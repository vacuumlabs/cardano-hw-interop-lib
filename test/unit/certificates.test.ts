...
import { ipv4ToBuffer, registerTests, rewardAccount, toFixlenBuffer, toMaxLenString, toUint } from '../test_utils'
...
registerTests('Parse certificates', parseCertificates, ValidCertificatesTestcases, InvalidCertificatesTestcases)
