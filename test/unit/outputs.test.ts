        ...
        parsed: [{
            ...
            amount: {
                ...
                multiasset: [{
                    ...
                    tokens: [{
                        assetName: Buffer.from('56616363756D546F6B656E73', 'hex') as MaxlenBuffer<32>,
...
registerTests('Parse transaction outputs', parseOutputs, ValidOutputsTestcases, InvalidOutputsTestcases)
